...
export async function checkFollowStatus(
  ...
  try {
    ...
    const response = await fetch(
      `${API_BASE_URL}/follows/?follower=${currentUserId}&following=${targetUserId}`,
      {
        method: 'GET',
        headers: {
...
export async function getFollowersCount(userId: number): Promise<number> {
  try {
    const response = await fetch(
      `${API_BASE_URL}/follows/?following=${userId}`,
      {
        method: 'GET'
      }
    );
...
export async function getFollowingCount(userId: number): Promise<number> {
  try {
    const response = await fetch(
      `${API_BASE_URL}/follows/?follower=${userId}`,
      {
        method: 'GET'
      }
    );
...
export async function getUserFollowers(
  ...
  try {
    const response = await fetch(
      `${API_BASE_URL}/follows/?following=${userId}&page=${page}&page_size=${pageSize}`,
      {
        method: 'GET',
        headers: {
...
export async function getUserFollowing(
  ...
  try {
    const response = await fetch(
      `${API_BASE_URL}/follows/?follower=${userId}&page=${page}&page_size=${pageSize}`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`
...
export async function getAllFollowings(userId: number) {
  try {
    const response = await fetch(
      `${API_BASE_URL}/follows/?follower_id=${userId}`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`
...
export async function getAllFollowers(userId: number) {
  try {
    const response = await fetch(
      `${API_BASE_URL}/follows/?following_id=${userId}`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`
